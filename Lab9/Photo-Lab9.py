...
if __name__ == "__main__":
    ### COPYING CODE FROM LAB 8 TO GET THE MODEL SYSTEM AND POINTS THAT WE ALREADY HAVE ###
    ...
    ### END OF COPIED OF CODE FROM LAB 8 ###

    ### COMPUTING Z VECTOR OF THE TEMP SYSTEM IN THE MODEL SYSTEM ###
    zvect1 = rd.Reader.ReadSampleFile(r'z-vector1.json')
    zvect2 = rd.Reader.ReadSampleFile(r'z-vector2.json')
    zvect3 = rd.Reader.ReadSampleFile(r'z-vector3.json')

    zvect1 = image2008.ImageToCamera(zvect1)
    zvect2 = image2009.ImageToCamera(zvect2)
    zvect3 = image2010.ImageToCamera(zvect3)

    zs = np.full((1, len(zvect1)), -focal * pixel_size)
